...
import com.example.poli_gas.databinding.ListItemPoligasExpressBinding
...
class ExpressOrderAdapter(val clickListener: PoliGasListener) : ListAdapter<DataItem, RecyclerView.ViewHolder>(PoliGasDiffCallback()) {
    ...
    class ViewHolder private constructor(val binding: ListItemPoligasExpressBinding) : RecyclerView.ViewHolder(binding.root) {

        fun bind(clickListener: PoliGasListener, item: PoliGas) {
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                val layoutInflater = LayoutInflater.from(parent.context)
                val binding = ListItemPoligasExpressBinding.inflate(layoutInflater, parent, false)
...
class PoliGasListener(val clickListener: (userId: String) -> Unit) {
